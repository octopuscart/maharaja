...
class Order extends CI_Controller {
    ...
    function orderPayment($order_key, $paymenttype) {
        ...
        $ganarateurl = "&return_url=$returnUrl&goods_subject=Maharaja Mart Order&app_pay=WEB&goods_body=$itemsdescription&api_version=2.8&lang=en&reuse=Y&active_time=300&wallet=HK";
...
=======
>>>>>>> c53ad5e970a54bc59b309c304bcfb3e7286ee68a
        }
        redirect(site_url("Order/orderdetails/$order_key"));
    }
